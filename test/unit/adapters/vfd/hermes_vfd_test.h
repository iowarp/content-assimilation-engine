#ifndef CAE_TEST_UNIT_CAE_ADAPTERS_HDF5_VFD_TESTS_H_
#define CAE_TEST_UNIT_CAE_ADAPTERS_HDF5_VFD_TESTS_H_
...
template <bool WITH_MPI> class Hdf5VfdTests : public FilesystemTests<f32> {
public:
  FileInfo new_file_;
...
#define TESTER hshm::Singleton<cae::test::Hdf5VfdTests<true>>::GetInstance()

#endif // CAE_TEST_UNIT_CAE_ADAPTERS_HDF5_VFD_TESTS_H_
