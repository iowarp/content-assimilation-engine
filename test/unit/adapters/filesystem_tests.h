#ifndef CAE_TEST_UNIT_CAE_ADAPTERS_FILESYSTEM_TESTS_H_
#define CAE_TEST_UNIT_CAE_ADAPTERS_FILESYSTEM_TESTS_H_
...
struct FileInfo {
  ...
  hshm::bitfield32_t flags_; /** Various flags */
};

template <typename T> class FilesystemTests {
public:
...
#endif // CAE_TEST_UNIT_CAE_ADAPTERS_FILESYSTEM_TESTS_H_
