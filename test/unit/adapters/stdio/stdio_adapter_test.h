#ifndef CAE_TEST_UNIT_CAE_ADAPTERS_STDIO_STDIO_ADAPTER_TEST_H_
#define CAE_TEST_UNIT_CAE_ADAPTERS_STDIO_STDIO_ADAPTER_TEST_H_

#include "binary_file_tests.h"

namespace cae::test {
template <bool WITH_MPI> class StdioTest : public BinaryFileTests {
public:
  FileInfo new_file_;
...
#define TESTER                                                                 \
  hshm::Singleton<cae::test::StdioTest<HERMES_MPI_TESTS>>::GetInstance()
#else
#define TESTER hshm::Singleton<cae::test::StdioTest<false>>::GetInstance()
#endif

#endif // CAE_TEST_UNIT_CAE_ADAPTERS_STDIO_STDIO_ADAPTER_TEST_H_
