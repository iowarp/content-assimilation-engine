#ifndef CAE_TEST_UNIT_CAE_ADAPTERS_BINARY_FILE_TESTS_H_
#define CAE_TEST_UNIT_CAE_ADAPTERS_BINARY_FILE_TESTS_H_
...
#endif // CAE_TEST_UNIT_CAE_ADAPTERS_BINARY_FILE_TESTS_H_
