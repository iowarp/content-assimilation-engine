#ifndef CAE_TEST_UNIT_CAE_ADAPTERS_POSIX_POSIX_ADAPTER_BASE_TEST_H_
#define CAE_TEST_UNIT_CAE_ADAPTERS_POSIX_POSIX_ADAPTER_BASE_TEST_H_
...
#define TESTER                                                                 \
  hshm::Singleton<cae::test::PosixTest<HERMES_MPI_TESTS>>::GetInstance()
#else
#define TESTER hshm::Singleton<cae::test::PosixTest<false>>::GetInstance()
#endif

#endif // CAE_TEST_UNIT_CAE_ADAPTERS_POSIX_POSIX_ADAPTER_BASE_TEST_H_
